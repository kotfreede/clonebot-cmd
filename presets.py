...
▞▞▞ 🅿🆁🅾🅲🅴🅳🆄🆁🅴 ▞▞▞
🔵 𝐉𝐨𝐢𝐧 𝐭𝐡𝐞 𝐬𝐨𝐮𝐫𝐜𝐞 𝐜𝐡𝐚𝐭 𝐚𝐬 𝐚 𝐦𝐞𝐦𝐛𝐞𝐫.
🔵 𝐉𝐨𝐢𝐧 𝐭𝐡𝐞 𝐝𝐞𝐬𝐭𝐢𝐧𝐚𝐭𝐢𝐨𝐧 𝐜𝐡𝐚𝐭 𝐚𝐬 𝐚𝐝𝐦𝐢𝐧.
🔵 𝐁𝐨𝐭 𝐝𝐨𝐞𝐬𝐧'𝐭 𝐧𝐞𝐞𝐝 𝐭𝐨 𝐢𝐧 𝐛𝐨𝐭𝐡 𝐜𝐡𝐚𝐭𝐬.
...
🔵 𝐓𝐨 𝐝𝐞𝐥𝐞𝐭𝐞 𝐭𝐡𝐞 𝐬𝐭𝐨𝐫𝐞𝐝 𝐜𝐡𝐚𝐭 𝐜𝐨𝐧𝐟𝐢𝐠:
𝐒𝐞𝐧𝐝 : <b>/delconfig</b>
...
My repo can be see (⦿‿⦿) <a href='https://t.me/KOT_BOTS'>𝙃𝙚𝙧𝙚</a>
    ...
    CLOSE_BTN_TXT = "<code>Be patient, You will get a prompt when finished. If you wish to cancel," \
                    "tap the button</code>"
